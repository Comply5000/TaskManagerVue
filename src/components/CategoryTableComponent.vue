          ...
          >
            <div class="relative flex-1">
              ...
              <label
                ...
                :class="{
                  'text-primary': categoryData.name,
                  'peer-focus:text-primary': !categoryData.name,
                }"
              >
                Name:
              </label>
            ...
            <div class="relative flex-1">
              ...
              <label
                ...
                class="absolute left-2 top-2 text-gray-600 transition-all duration-300"
                :class="{
                  'text-primary': categoryData.description,
                  'peer-focus:text-primary': !categoryData.description,
                }"
              >
                Description:
              </label>
            ...
            <div class="relative flex-1">
              ...
              <label
                ...
                class="absolute left-2 top-2 text-gray-600 transition-all duration-300"
                :class="{
                  'text-primary': categoryData.pageUrl,
                  'peer-focus:text-primary': !categoryData.pageUrl,
                }"
              >
                Page URL:
              </label>
        ...
        <div class="min-w-max">
          <div class="w-max mx-auto bg-white rounded-lg shadow-lg">
            <div class="overflow-hidden">
              <table
                class="mb-20 w-full text-center text-sm font-light divide-gray-200"
              >
                <thead
                    ...
                    <td class="whitespace-nowrap px-6 py-4 text-center">
                      <div class="relative">
                        <button
                          @click="
                            showOptions =
                              showOptions === category.id ? null : category.id
                          "
                        ...
                        <ul
                          ...
                          class="absolute top-8 right-0 bg-white border border-gray-300 dark:bg-neutral-800 dark:border-neutral-700 rounded-lg shadow-lg z-10"
                        >
                          <li
                            @click.stop="updateTask(category.id)"
                            class="py-2 px-4 hover:bg-gray-100 dark:hover:bg-neutral-700 cursor-pointer"
                          >
                            Update
                          </li>
                          <li
...
export default {
  ...
  methods: {
    createCategory() {
      ...
      axios
        .post(`/task-categories`, this.categoryData, {
          headers: {
    ...
    deleteCategory(categoryId) {
      const userConfirmed = window.confirm(
        'Are you sure you want to delete this category? It will delete all assigned tasks and files!'
      );
      ...
      if (userConfirmed) {
        ...
        axios
          .delete(`/task-categories/${categoryId}`, {
            headers: {
              Authorization: `Bearer ${token}`,
            },
          })
